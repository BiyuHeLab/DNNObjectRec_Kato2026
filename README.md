...
### **codes/**
Code to reproduce the figures. To generate the figures, set the `rootD` variable at the top of each script to the project home directory (the directory containing this README), then run the scripts. To perform multiple-comparison correction, download [fdr_bh.m](https://www.mathworks.com/matlabcentral/fileexchange/27418-fdr_bh) and place it in this folder.
